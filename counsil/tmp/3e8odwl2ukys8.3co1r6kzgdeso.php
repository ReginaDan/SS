                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/counsil/">
                            <img src="<?php echo $BASE; ?>/ui/images/logo.png" alt="">
                        </a>
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav navbar-right">
                                ...
                                <ul class="dropdown-menu multi-level">
	                              <?php foreach (($commitees?:array()) as $com): ?>
	                                ...
	                                <ul class="dropdown-menu">
						                ...
						                <li><a href="/counsil/commitees/blog/link/<?php echo $com['link']; ?>">Блог</a></li>  
	                                </ul>
	                                </li> 
	                                <?php endforeach; ?> 
									</ul>
                            ...
                            <li class="dropdown a_dropdown"><a href="locals" class="dropdown-toggle" data-toggle="dropdown" >ФАКУЛЬТЕТЫ</a>
                            <ul class="dropdown-menu multi-level">
