                ...
                <div class="panel col-md-6 col-md-offset-3" style="padding: 0; border: 0;">
                    ...
                    <div class="panel-body">
                      <form method="post" method="POST" enctype="multipart/form-data" action="" id="update" class="form-horizontal" role="form">
                        <label for="inputStandard" class="col-lg-3 control-label">Партнер</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="name" class="form-control" placeholder="Название" value="<?php echo $partners['name']; ?>">
                            </div>
                          </div>
                          <label for="inputStandard" class="col-lg-3 control-label">Ссылка</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="link" class="form-control" placeholder="Ссылка" value="<?php echo $partners['link']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Логотип</label>
