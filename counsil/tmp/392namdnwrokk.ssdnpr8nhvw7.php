              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Блог комитета "<?php echo $commitee['0']['name']; ?>"</div>
                </div>
                <div class="panel-body pn">
                    ...
                    <thead>
                     ...
                     <tbody>
	                    <?php foreach (($bnews?:array()) as $bnew): ?>
		                    <tr>
			                    <td><?php echo $bnew['bnname']; ?></td>
			                    <td><?php echo $bnew['bnd']; ?></td>
			                    <td><?php echo $bnew['picture']; ?></td>
			                    <td><?php echo $this->raw(substr($bnew['bntx'],0,280).'...'); ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/commitees/blogs/link/<?php echo $bnew['comlink']; ?>/change/<?php echo $bnew['nid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/commitees/blogs/link/<?php echo $bnew['comlink']; ?>/delete/<?php echo $bnew['nid']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $bnew['nid']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/commitees/blogs/link/<?php echo $commitee['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>   
                </div>
              </div>
            </div>
