              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Основная информация об уполномоченном по правам студентов НИУ ВШЭ</div>
                </div>
                  ...
                  <table  class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
	                    <?php foreach (($ombudsman?:array()) as $om): ?>
		                    <tr>
			                    <td><?php echo $om['pname']; ?></td>
		                        <td><?php echo $om['psurname']; ?></td>
		                        <td><?php echo $om['pphoto']; ?></td>
		                        <td><?php echo $om['dname']; ?></td>
		                        <td><?php echo $om['pe']; ?></td>
		                        <td><?php echo $om['pv']; ?></td>
		                        <td><?php echo $om['pf']; ?></td>
		                        <td><?php echo $om['pt']; ?></td>
		                       <td><a href="change/<?php echo $om['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a><a href="delete/<?php echo $om['pid']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a></td>
		                    </tr>
	                    <?php endforeach; ?>
                    </tbody>
                  </table>
				  <a href="<?php echo $BASE; ?>/admin/ombudsman/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
