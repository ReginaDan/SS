              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Проект</label>
							<div class="col-lg-8" >
								<div>
		          ...
		          <div class="panel">
		            <div class="panel-body pn of-h" id="summer-demo">
		              <textarea name="description" class="summernote" ><?php echo $projects['0']['description']; ?>
