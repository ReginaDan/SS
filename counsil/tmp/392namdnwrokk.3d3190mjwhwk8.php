              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Партнеры студсовета</div>
                </div>
                <div class="panel-body pn">
                     ...
                     <tbody>
	                    <?php foreach (($partners?:array()) as $par): ?>
		                    <tr>
			                    ...
			                    <td><?php echo $par['link']; ?></td>
			                    <td><?php echo $par['photo']; ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/about/partners/change/<?php echo $par['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/about/partners/delete/<?php echo $par['id']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $par['id']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/about/partners/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
          </div>
