              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Команда уполномоченного по правам студентов НИУ ВШЭ</div>
                </div>
                <div class="panel-body pn">
                  <table class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
	                    <?php foreach (($member?:array()) as $mem): ?>
                            ...
                            <form method="post">
		                          <td>
                                <a href="<?php echo $BASE; ?>/admin/ombudsman/team/change/<?php echo $mem['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $mem['pid']; ?>"> 
                 ...
                 <a href="<?php echo $BASE; ?>/admin/ombudsman/team/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
