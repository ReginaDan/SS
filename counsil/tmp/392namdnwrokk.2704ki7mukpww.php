          ...
          <div class="row">
              ...
              <div class="panel panel-visible" id="spy1">
                ...
                <div class="panel-body pn">
                  <table class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
	                    <?php foreach (($news?:array()) as $new): ?>
		                    <tr>
			                    <td><?php echo $new['nname']; ?></td>
			                    <td><?php echo $this->raw(substr($new['ntext'],0,280).'...'); ?></td>
			                    <td><?php echo $new['npict']; ?></td>
			                    <td><?php echo $new['author']; ?></td>
			                    <td><?php echo $new['ndate_created']; ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/news/change/<?php echo $new['nid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/news/delete/<?php echo $new['nid']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $new['nid']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/news/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>                
				  </div>
              </div>
            </div>
          </div>
