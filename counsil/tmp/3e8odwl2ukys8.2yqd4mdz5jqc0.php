...
<head>
    ...
    <link href="<?php echo $BASE; ?>/ui/css/font-awesome.css" rel="stylesheet">
    <!-- Custom Main StyleSheet CSS -->
    <link href="<?php echo $BASE; ?>/ui/css/style.css" rel="stylesheet">
    <!-- Responsive CSS -->
    <link href="<?php echo $BASE; ?>/ui/css/responsive.css" rel="stylesheet">
</head>
