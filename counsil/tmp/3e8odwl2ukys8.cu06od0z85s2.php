<div id="mySidenav" class="sidenav">
    ...
    <ul class="nav navbar-nav">
       ...
       <li class="dropdown a_dropdown"><a href="cometee" class="dropdown-toggle" data-toggle="dropdown" >Комитеты</a>
            <ul class="dropdown-menu multi-level">
	            <?php foreach (($commitees?:array()) as $com): ?>
	                <li class="dropdown-submenu"><a><?php echo $com['name']; ?></a>
	                    <ul class="dropdown-menu">
							<li><a href="/counsil/commitee/info/link/<?php echo $com['link']; ?>">Основная информация</a></li>
						    <li><a href="/counsil/commitee/projects/link/<?php echo $com['link']; ?>">Проекты</a></li>
						    <li><a href="/counsil/commitee/blog/link/<?php echo $com['link']; ?>">Блог</a></li>  
	                    </ul>
	                 </li> 
	            <?php endforeach; ?> 
			</ul>
