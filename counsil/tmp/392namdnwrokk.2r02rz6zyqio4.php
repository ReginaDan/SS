              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Студенческие организации</div>
                </div>
                <div class="panel-body pn">
                  <table id="example" class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
	                    <?php foreach (($organizations?:array()) as $org): ?>
		                    <tr>
			                    <td><?php echo $org['oname']; ?></td>
			                    <td><?php echo $org['opict']; ?></td>
			                    <td><?php echo $this->raw($org['odesc']); ?></td>
			                    <td><?php echo $org['odate_created']; ?></td>
			                    <td><?php echo $org['dname']; ?> <?php echo $org['dsname']; ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/organizations/list/change/<?php echo $org['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/organizations/list/delete/<?php echo $org['id']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $org['id']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/organizations/list/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
          </div>
