        ...
        <div class="col-sm-10  ">
          ...
          <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    Руководитель студенческой организации
                   </div>
                </div>
              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Имя</label>
							<div class="col-lg-8" >
								<div>
									<input type="text" name="name" id="inputStandard" class="form-control" placeholder="Имя">
	                    		</div>
                    		</div>
                  		</div>
	                </div>
	                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Руководитель</label>
	                          <div class="section">
	                          <label class="field select" class="col-lg-12" style="padding: 10px 10px 20px;">
	                            <select id="director" name="director">
	                              <option value="<?php echo $organizations['id_director']; ?>"><?php echo $directors['dname']; ?> <?php echo $directors['dsurname']; ?></option>
	                              <?php foreach (($directors?:array()) as $dir): ?>
	                                  <option value="<?php echo $dir['id']; ?>"><?php echo $dir['name']; ?> <?php echo $dir['surname']; ?></option>
	                              <?php endforeach; ?>
	                            </select>
	                            <i class="arrow"></i>
	                          </label>
                    ...
                    <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Логотип</label>
		          ...
		          <div class="panel">
		            <div class="panel-body pn of-h" id="summer-demo">
		              <textarea name="description" class="summernote" ><?php echo $organization['0']['odesc']; ?>
