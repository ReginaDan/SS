              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Секретарь студсовета</div>
                </div>
                  ...
                  <table  class="table" cellspacing="0" width="100%">
                    ...
                    <?php foreach (($people2?:array()) as $p): ?>
		                    <tr>
		                        ...
		                        <td><?php echo $p['pt']; ?></td>
		                        <td>
			                        <a href="secretary/change/<?php echo $p['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
			                        <a href="secretary/delete/<?php echo $p['pid']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a>
			                    </td>
		                    </tr>
	                    <?php endforeach; ?>
                 </table>
                 <a href="<?php echo $BASE; ?>/admin/contain/secretary/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
          </div>
