...
<?php echo $this->render('views/admin/base/sidebar.htm',$this->mime,get_defined_vars(),0); ?>
              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Проекты комитета "<?php echo $commitee['0']['name']; ?>"</div>
                </div>
                <div class="panel-body pn">
                  <table  class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
	                    <?php foreach (($projects?:array()) as $proj): ?>
		                    <tr>
			                    <td><?php echo $proj['pname']; ?></td>
			                    <td><?php echo $proj['pdate']; ?></td>
			                    <td><?php echo $proj['picture']; ?></td>
			                    <td><?php echo $this->raw(substr($proj['pdesc'],0,280).'...'); ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/commitees/projects/link/<?php echo $proj['comlink']; ?>/change/<?php echo $proj['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/commitees/projects/link/<?php echo $proj['comlink']; ?>/delete/<?php echo $proj['id']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $proj['id']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/commitees/projects/link/<?php echo $commitee['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>                </div>
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- Datatabl<?php echo $BASE; ?>/ui/views/admin/es Tabletools addon -->
