              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Новость</label>
							<div class="col-lg-8" >
								<div>
									<input type="text" name="name" id="inputStandard" class="form-control" placeholder="Название">
	                    		</div>
                    		</div>
                  		</div>
	                </div>
	                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Автор</label>
							<div class="col-lg-8" >
								<div>
									<input type="text" name="author" id="inputStandard" class="form-control" placeholder="Имя и Фамилия">
	                    		</div>
                    		</div>
						</div>
	                </div>
                    <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Картинка</label>
								<div class="section col-lg-8" style="padding: 10px 10px 20px;">
									<input type="file" name="picture">
                          		</div>
						</div>
                    </div>
                                                      <input type="hidden" name="loclink" value="<?php echo $local['0']['link']; ?>">
		          ...
		          <div class="panel">
		            <div class="panel-body pn of-h" id="summer-demo">
		              <textarea name=" text" class="summernote" ><?php echo $bnews['0']['ntext']; ?>
