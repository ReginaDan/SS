          ...
          <div class="row">
              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Председатель <?php echo $local['0']['name']; ?></div>
                </div>
                <div class="panel-body pn">
                    ...
                    <tbody>
	                    <?php foreach (($head?:array()) as $h): ?>
		                    <tr>
		                        ...
		                        <td><?php echo $h['psurname']; ?></td>
		                        <td><?php echo $h['pphoto']; ?></td>
		                        ...
		                        <td><?php echo $h['pt']; ?></td>
		                        <td>
				                    <a href="<?php echo $BASE; ?>/admin/locals/members/head/link/<?php echo $local['0']['link']; ?>/change/<?php echo $h['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/locals/members/head/link/<?php echo $local['0']['link']; ?>/delete/<?php echo $h['pid']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $local['0']['id']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/locals/members/head/link/<?php echo $local['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>                        </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Секретарь <?php echo $local['0']['name']; ?></div>
                </div>
                <div class="panel-body pn">
                  <table  class="table" cellspacing="0" width="100%">
                    <thead>
                    ...
                    <tbody>
	                    <?php foreach (($secretary?:array()) as $sec): ?>
		                    <tr>
			                    <td><?php echo $sec['pname']; ?></td>
		                        <td><?php echo $sec['psurname']; ?></td>
		                        <td><?php echo $sec['pphoto']; ?></td>
		                        <td><?php echo $sec['dname']; ?></td>
		                        <td><?php echo $sec['pe']; ?></td>
		                        <td><?php echo $sec['pv']; ?></td>
		                        <td><?php echo $sec['pf']; ?></td>
		                        <td><?php echo $sec['pt']; ?></td>
		                        <td>
				                    <a href="<?php echo $BASE; ?>/admin/locals/members/secretary/link/<?php echo $local['0']['link']; ?>/change/<?php echo $sec['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/locals/members/secretary/link/<?php echo $local['0']['link']; ?>/delete/<?php echo $sec['pid']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $local['0']['id']; ?>"> 
	                                <button style="margin-top:5px" type="submit" id="delete" name="delete"  class="btn btn-xs btn-danger btn-block">Удалить</button>
	                                </form>
                                </td>
				  ...
				  <a href="<?php echo $BASE; ?>/admin/locals/members/secretary/link/<?php echo $local['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>        
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Члены <?php echo $local['0']['name']; ?></div>
                </div>
                <div class="panel-body pn">
                  <table  class="table" cellspacing="0" width="100%">
                    <thead>
                    ...
                    <tbody>
	                    <?php foreach (($member?:array()) as $mem): ?>
		                    <tr>
		                        ...
		                        <td>
				                    <a href="<?php echo $BASE; ?>/admin/locals/members/link/<?php echo $local['0']['link']; ?>/change/<?php echo $mem['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/locals/members/members/link/<?php echo $local['0']['link']; ?>/delete/<?php echo $mem['pid']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $local['0']['id']; ?>"> 
	                                <button style="margin-top:5px" type="submit" id="delete" name="delete"  class="btn btn-xs btn-danger btn-block">Удалить</button>
	                                </form>
                                </td>
				  ...
				  <a href="<?php echo $BASE; ?>/admin/locals/members/link/<?php echo $local['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>                        </div>
              </div>
            </div>
