          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row center-block mt10" style="">
                <div class="panel col-md-8 col-md-offset-2" style="padding: 0; border: 0;">
                      ...
                      <form method="post" method="POST" enctype="multipart/form-data" action="" id="update" class="form-horizontal" role="form">
                        <label for="inputStandard" class="col-lg-3 control-label">Документ</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="name" class="form-control" placeholder="Название" value="<?php echo $documents['0']['dname']; ?>">
                            </div>
                          </div>
