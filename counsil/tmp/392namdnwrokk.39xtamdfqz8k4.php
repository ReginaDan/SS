                      ...
                      <form method="post" method="POST" enctype="multipart/form-data" id="update" class="form-horizontal" role="form">
                        <label for="inputStandard" class="col-lg-3 control-label">Комитет</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="name" class="form-control" placeholder="<?php echo $commitees['0']['name']; ?>" value="">
                            </div>
                          </div>
                          <label for="inputStandard" class="col-lg-3 control-label">Ссылка</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="link" class="form-control" placeholder="<?php echo $commitees['0']['link']; ?>" value="">
                            </div>
                          </div>
