              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Блог <?php echo $local['0']['name']; ?></div>
                </div>
                <div class="panel-body pn">
                    ...
                    <tbody>
	                    <?php foreach (($bnews?:array()) as $bnew): ?>
		                    <tr>
			                    ...
			                    <td><?php echo $this->raw($bnew['bntx']); ?></td>
			                    <td><?php echo $bnew['picture']; ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/locals/blogs/link/<?php echo $local['0']['link']; ?>/change/<?php echo $bnew['nid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/locals/blogs/link/<?php echo $local['0']['link']; ?>/delete/<?php echo $bnew['nid']; ?>">
				  ...
				  <a href="<?php echo $BASE; ?>/admin/locals/blogs/link/<?php echo $local['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>                                </div>
              </div>
            </div>
          </div>
        </div>
