                     ...
                     <tbody>
	                   <?php foreach (($commitees?:array()) as $com): ?>
	                    <tr>
		                    ...
		                    <td><?php echo $com['link']; ?></td>
		                    <td>
			                   <a href="change/<?php echo $com['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
			                   <a href="delete/<?php echo $com['id']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a>
			                </td>
		                    </tr>
	                    <?php endforeach; ?>
                 </table>
                 <a href="<?php echo $BASE; ?>/admin/commitees/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
