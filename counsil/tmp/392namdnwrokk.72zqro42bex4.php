                      ...
                      <form method="post" method="POST" enctype="multipart/form-data" action="" id="update" class="form-horizontal" role="form">
                        <label for="inputStandard" class="col-lg-3 control-label">Комитет</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="name" class="form-control" placeholder="Название" value="<?php echo $commitee['name']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">О комитете</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="info" class="form-control" placeholder="Информация" value="<?php echo $commitee['info']; ?>">
                            </div>
                          </div>
