              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12">
						<div class="form-group">
							...
							<div class="col-lg-8" >
								<div>
									<input type="text" name="name" id="inputStandard" class="form-control" value="<?php echo $news['0']['nname']; ?>">
	                    		</div>
                    		</div>
                  		</div>
	                </div>
	                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 40px" class="col-lg-3 control-label">Автор</label>
							<div class="col-lg-8" >
								<div>
									<input type="text" name="author" id="inputStandard" class="form-control" value="<?php echo $news['0']['author']; ?>">
	                    		</div>
                    		</div>
						</div>
	                </div>
						...
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 30px" class="col-lg-3 control-label">Картинка</label>
								<div class="section col-lg-8" style="padding: 10px 10px 20px;">
									...
									<input name="prev_picture" value="<?php echo $news['0']['npict']; ?>" class="hidden"/>
                          		</div>
						</div>
                    </div>
                                                      <input class="hidden" name="loclink" value="<?php echo $link; ?>">
              </div>
            </div>

		          <div class="panel">
		            <div class="panel-body pn of-h" id="summer-demo">
		              <textarea name="text" class="summernote" ><?php echo $news['0']['ntext']; ?>
