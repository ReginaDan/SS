...
<?php echo $this->render('views/admin/base/sidebar.htm',$this->mime,get_defined_vars(),0); ?>
              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Категории документов Студсовета НИУ ВШЭ</div>
                </div>
                     ...
                     <tbody>
	                   <?php foreach (($categories?:array()) as $cat): ?>
	                    <tr>
		                    ...
		                    <td>
			                   <a href="change/<?php echo $cat['cid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
			                   <a href="delete/<?php echo $cat['cid']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a>
			                </td>
		                    </tr>
	                    <?php endforeach; ?>
                 </table>
                 <a href="<?php echo $BASE; ?>/admin/documents/categories/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
  ...
  jQuery(document).ready(function() {
    ...
    editor = new $.fn.dataTable.Editor({
      ajax: "<?php echo $BASE; ?>/ui/views/admin/vendor/plugins/datatables/extensions/Editor/examples/php/staff.php",
      table: "#example",
      fields: [{
        label: "Название:",
        name: "_name"
