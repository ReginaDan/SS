...
<?php echo $this->render('views/admin/base/sidebar.htm',$this->mime,get_defined_vars(),0); ?>
              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Председатель студсовета</div>
                </div>
                    ...
                    <thead>
                     ...
                     <?php foreach (($people1?:array()) as $p): ?>
		                    <tr>
		                        ...
		                        <td><?php echo $p['psurname']; ?></td>
		                        <td><?php echo $p['pphoto']; ?></td>
		                        <td><?php echo $p['dname']; ?></td>
		                        <td><?php echo $p['pe']; ?></td>
		                        <td><?php echo $p['pv']; ?></td>
		                        <td><?php echo $p['pf']; ?></td>
		                        <td><?php echo $p['pt']; ?></td>
		                        <td>
			                        <a href="head/change/<?php echo $p['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
			                        <a href="head/delete/<?php echo $p['pid']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a>
			                    </td>
		                    </tr>
	                    <?php endforeach; ?>
                 </table>
                 <a href="<?php echo $BASE; ?>/admin/contain/head/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="vendor/plugins/datatables/extensions/Editor/js/editor.bootstrap.js"></script>
