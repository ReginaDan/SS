        ...
        <div class="col-sm-12 ">
          ...
          <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Основная информация о комитете "<?php echo $commitee['0']['name']; ?>"</div>
                </div>
                <form method="post" enctype="multipart/form-data">
		          <div class="panel">
		            <div class="panel-body pn of-h" id="summer-demo">
		            
		              <textarea name="info" class="summernote" ><?php echo $commitee['0']['info']; ?>
                          ...
                          <div class="section col-lg-8" style="padding: 10px 10px 20px;">
                                        ...
                                        <input type="hidden" name="commitee" value="<?php echo $link; ?>">
                          </div>
