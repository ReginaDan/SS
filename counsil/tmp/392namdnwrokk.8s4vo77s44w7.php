              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Руководители комитетов студсовета</div>
                </div>
                    ...
                    <tbody>
	                    ...
	                    <?php foreach (($people3?:array()) as $p): ?>
		                    <tr>
		                        ...
		                        <td><?php echo $p['pt']; ?></td>
		                        <td>
			                        <a href="commitees_heads/change/<?php echo $p['pid']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
			                        <a href="commitees_heads/delete/<?php echo $p['pid']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a>
			                        </td>
		                    </tr>
	                    <?php endforeach; ?>
                    </tbody>
                  </table>
				  <a href="<?php echo $BASE; ?>/admin/contain/commitees_heads/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
          </div>
