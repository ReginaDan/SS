    ...
    <section id="content_wrapper">
      ...
      <section id="content" class="table-layout animated fadeIn">
              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Комитеты студсовета</div>
                </div>
                <div class="panel-body pn">
                  ...
                  <tbody>
	                  <?php foreach (($commitees?:array()) as $com): ?>
		                  <tr>
			                  ...
			                  <td><?php echo $com['info']; ?></td>
			                  <td>
				                <a href="<?php echo $BASE; ?>/admin/about/commitees/change/<?php echo $com['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
                                <form method="post" action="<?php echo $BASE; ?>/admin/about/commitees/delete/<?php echo $com['id']; ?>">
                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $mcom['id']; ?>"> 
                  ...
                  <button type="button" class="btn btn-sm btn-dark btn-block">Добавить</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- end: .tray-center -->
              ...
              <?php echo $this->render('views/admin/base/footer.htm',$this->mime,get_defined_vars(),0); ?>
