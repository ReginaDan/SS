              ...
              <div class="panel panel-visible" id="spy1">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Документы <?php echo $departments['0']['dname']; ?></div>
                </div>
                <div class="panel-body pn">
                  <table  class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
	                    <?php foreach (($localdocs?:array()) as $doc): ?>
		                    <tr>
			                    <td><?php echo $doc['name']; ?></td>
			                    <td><?php echo $doc['cname']; ?></td>
			                    <td><?php echo $doc['dlink']; ?></td>
			                    <td>
				                    <a href="<?php echo $BASE; ?>/admin/locals/documents/link/<?php echo $local['0']['link']; ?>/change/<?php echo $doc['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
	                                <form method="post" action="<?php echo $BASE; ?>/admin/locals/documents/link/<?php echo $local['0']['link']; ?>/delete/<?php echo $doc['id']; ?>">
	                                <input type="text" name="id" id="id" class="hidden" value="<?php echo $doc['id']; ?>"> 
				  ...
				  <a href="<?php echo $BASE; ?>/admin/locals/documents/link/<?php echo $local['0']['link']; ?>/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>                                </div>
                </div>
              </div>
            </div>
