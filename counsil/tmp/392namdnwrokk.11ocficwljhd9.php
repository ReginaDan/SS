              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12">
						<div class="form-group">
							<label for="inputStandard" style="text-align: center; line-height: 20px" class="col-lg-3 control-label">Организация</label>
							<div class="col-lg-8" >
								<div>
									<input type="text" name="name" id="inputStandard" class="form-control" placeholder="<?php echo $organizations['0']['oname']; ?>">
	                    		</div>
                    		</div>
                  		</div>
	                </div>
		          ...
		          <div class="panel">
		            <div class="panel-body pn of-h" id="summer-demo">
		              <textarea name="description" class="summernote" ><?php echo $organizations['0']['odesc']; ?>
