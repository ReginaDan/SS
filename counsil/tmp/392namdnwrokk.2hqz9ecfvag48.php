                    ...
                    <tbody>
	                    <?php foreach (($documents?:array()) as $doc): ?>
		                    <tr>
			                    ...
			                    <td>
			                   <a href="<?php echo $BASE; ?>/admin/documents/change/<?php echo $doc['id']; ?>" type="button" class="btn btn-xs btn-info btn-block">Изменить</a>
			                   <a href="<?php echo $BASE; ?>/admin/documents/delete/<?php echo $doc['id']; ?>" type="button" class="btn btn-xs btn-danger btn-block">Удалить</a>
			                </td>
		                    </tr>
	                    <?php endforeach; ?>
                 </table>
                 <a href="<?php echo $BASE; ?>/admin/documents/add" type="button" class="btn btn-sm btn-dark btn-block">Добавить</a>
                </div>
              </div>
            </div>
          </div>
