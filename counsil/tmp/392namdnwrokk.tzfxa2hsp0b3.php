                      ...
                      <form method="post" method="POST" enctype="multipart/form-data" id="update" class="form-horizontal" role="form">
                        <label for="inputStandard" class="col-lg-3 control-label">Имя</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="firstname" class="form-control" placeholder="Имя" value="<?php echo $people1['name']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Фамилия</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="secondname" class="form-control" placeholder="Фамилия" value="<?php echo $people1['surname']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Школа</label>
                          ...
                          <label class="field select" class="col-lg-8" style="padding: 10px 10px 20px;">
                            <select id="faculty" name="faculty">
                              <option value="<?php echo $people1['id_school']; ?>"><?php echo $people1['school']; ?></option>
                        ...
                        <label for="inputStandard" class="col-lg-3 control-label">ВК</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" name="vk" class="form-control" placeholder="ВК" value="<?php echo $people1['vk']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Facebook</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="facebook" class="form-control" placeholder="facebook" value="<?php echo $people1['facebook']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Twitter</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="twitter" class="form-control" placeholder="Твиттер" value="<?php echo $people1['twitter']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Email</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="email" class="form-control" placeholder="Почта" value="<?php echo $people1['email']; ?>">
                            </div>
                          </div>
                        <input type="text" id="inputStandard" name="photo" class="form-control hidden" value="<?php echo $people1['[photo]']; ?>">
