                ...
                <div class="row">
	                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12">
	                    <div class="a_f_block">
							...
							<div class="a_control">
		                        <a class="left carousel-control" href="/counsil/news/<?php echo $offsetBack; ?>" data-slide="prev"> 
		                            <i class="fa fa-chevron-left" aria-hidden="true"></i> 
		                        </a>
		                        <a class="right carousel-control" href="/counsil/news/<?php echo $offset; ?>" data-slide="next"> 
