                ...
                <div class="row">
	                ...
	                <div class="col-sm-6">
	                    <div class="a_f_block_team a_list_members">
		                    ...
		                    <div class="a_member">			                   
				                    <img src="ui/images/<?php echo $h['pphoto']; ?>">
	                ...
	                <div class="col-sm-6">
	                    <div class="a_f_block_team a_list_members">
		                    ...
		                    <div class="a_member">			                   
				                    <img src="ui/images/<?php echo $sec['pphoto']; ?>">
                        ...
                        <div class="a_faq_list">
                            <ul class="a_list_dep " style=" -webkit-padding-start: 30px;">
	                            <?php foreach (($schools?:array()) as $sch): ?>
                                 <?php if ($sch['id']=='1'): ?> <li class="active" >  <?php else: ?><li> <?php endif; ?> <a href="#<?php echo $sch['id']; ?>" data-toggle="tab"><?php echo $sch['name']; ?></a></li>	
                                <?php endforeach; ?>
                            </ul>
                        </div>
						 ...
						 <div class="col-sm-12">
	                        <div class="tab-content">
		                        <?php foreach (($schools?:array()) as $sch): ?>
		                        <div id="<?php echo $sch['id']; ?>" class="fade in tab-pane">
		                        ...
		                        <div class="a_member" >	
	                               ...
	                               <img src="ui/images/<?php echo $mem['pphoto']; ?>">
