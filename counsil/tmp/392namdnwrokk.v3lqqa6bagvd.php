                      ...
                      <form method="post" method="POST" enctype="multipart/form-data" id="update" class="form-horizontal" role="form">
                        <label for="inputStandard" class="col-lg-3 control-label">Имя</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="firstname" class="form-control" placeholder="Имя" value="<?php echo $secretary['0']['pname']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Фамилия</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div>
                              <input type="text" id="inputStandard" name="secondname" class="form-control" placeholder="Фамилия" value="<?php echo $secretary['0']['psurname']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Школа</label>
                          ...
                          <label class="field select" class="col-lg-8" style="padding: 10px 10px 20px;">
                            <select id="faculty" name="faculty">
                              <option value="<?php echo $secretary['0']['sid']; ?>"><?php echo $secretary['0']['sname']; ?></option>
                        ...
                        <label for="inputStandard" class="col-lg-3 control-label">ВК</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" name="vk" class="form-control" placeholder="ВК" value="<?php echo $secretary['0']['pv']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Facebook</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="facebook" class="form-control" placeholder="facebook" value="<?php echo $secretary['0']['pf']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Twitter</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="twitter" class="form-control" placeholder="Твиттер" value="<?php echo $secretary['0']['pt']; ?>">
                            </div>
                          </div>
                        <label for="inputStandard" class="col-lg-3 control-label">Email</label>
                          <div class="col-lg-8" style="padding-bottom: 20px;">
                            <div >
                              <input type="text" id="inputStandard" name="email" class="form-control" placeholder="Почта" value="<?php echo $secretary['0']['pe']; ?>">
                            </div>
                          </div>
                        <input type="text" id="inputStandard" name="photo" class="form-control hidden" value="<?php echo $secretary['0']['pphoto']; ?>">
