...
<?php echo $this->render('views/admin/base/sidebar.htm',$this->mime,get_defined_vars(),0); ?>
    ...
    <section id="content_wrapper">
      ...
      <section id="content" class="table-layout animated fadeIn">
        ...
        <!-- begin: .tray-center -->
        <div class="col-sm-10 tray tray-center">

          <!-- Summernote Editor -->
          <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span ></span>Обращение уполномоченного по правам студентов НИУ ВШЭ</div>
                </div>
                <form method="post">
          <div class="panel">
            <div class="panel-body pn of-h" id="summer-demo">
            
              <textarea name="allocution" class="summernote" ><?php echo $allocution['0']['text']; ?>
